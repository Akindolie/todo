...
import '../providers/todo_providers.dart' as todo_providers;
...
class TodoScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final filteredTodos = ref.watch(todo_providers.filteredTodosProvider);
  ...
  void _addTodo(WidgetRef ref, String title) {
    if (title.trim().isNotEmpty) {
      ...
      ref.read(todo_providers.todoListProvider.notifier).addTodo(title);
      _controller.clear();
    }
  }
}
